...
###PURPOSE: Calculate relative growth length values for raw growth data
###This data will later be used for creating thermal performance curves
...
#All values in this dataset contain measurements for Avg secondary going in--however, some may have no measurement
#for Avg secibdary coming out due to plant deterioration; therefore correct these NAs to zero
