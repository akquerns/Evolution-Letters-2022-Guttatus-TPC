...
###OUTPUT: Fig. 3: Thermal performance curves for native/invasive populations
...
###
write.csv(tidy_perf_pops, "TPC-outputs/FinPopCodes/tidy_perf_pops_subset-pops.csv", row.names = FALSE)
write.csv(creds_pops, "TPC-outputs/FinPopCodes/creds_pops_subset-pops.csv", row.names=FALSE)
write.csv(gutDat, "Processed-data/gutDat_subset-pops.csv", row.names = FALSE)
write.csv(mean_df, "TPC-outputs/FinPopCodes/mean_df_subset-pops.csv", row.names=FALSE)
write.csv(mean_df_ci, "TPC-outputs/FinPopCodes/mean_df_ci_subset-pops.csv", row.names=FALSE)
...
##Fig. 3 in manuscript:
pdf("Figures/Manuscript/Fig3.pdf", height=3.5, width=8)
