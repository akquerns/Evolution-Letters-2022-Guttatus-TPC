...
###PURPOSE: conduct a PCA on temperature related variables for ALL of my available populations
#This PCA aided my selection of populations which were used
#in my temperature growth experiments by showing how populations were distributed
#across the range of temperature-related bioclimatic variables.
#This allowed me to select populations without over-representing specific thermal environments

###Fig. S1: PCA of temperature related variables for populations
...
## remove variables unnecessary for TEMPERATURE PCA and rows with NA if applicable##
